CLASS zcl_mlb_empl_gen DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_mlb_empl_gen IMPLEMENTATION.
  ...
  METHOD if_oo_adt_classrun~main.
    ...
    DATA employees TYPE TABLE OF zmlb_employee.
    DATA employee TYPE zmlb_employee.
    DATA requests TYPE TABLE OF zmlb_vac_req.
    DATA request TYPE zmlb_vac_req.
    DATA demands TYPE TABLE OF zmlb_vac_dem.
    DATA demand TYPE zmlb_vac_dem.

    "DBT löschen
    DELETE FROM zmlb_employee.

    DELETE FROM zmlb_vac_req.

    DELETE FROM zmlb_vac_dem.

    "DBT Draft löschen
    "DELETE FROM zmlb_employe_d.
    "DELETE FROM zmlb_vac_req_d.
    "DELETE FROM zmlb_vac_dem_d.
    ...
    INSERT zmlb_employee FROM TABLE @employees.
    INSERT zmlb_vac_req FROM TABLE @requests.
    INSERT zmlb_vac_dem FROM TABLE @demands.
